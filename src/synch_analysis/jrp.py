        ...
        results.append(
            {
                ...
                "max_sustained_tu": max_sustained_sec,
            }
        )
...
def compute_scores(
    ...
    # Both dataframes should have 'lag' and 'lag_tu' columns
    merged = (
        kuramoto_df.merge(jrp_df, on=["lag", "lag_tu"], how="outer").sort_values("lag").reset_index(drop=True)
    )
